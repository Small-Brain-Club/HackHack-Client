...
public class HackHackGui extends GuiScreen
{
	...
	private Object fontRenderer;

    public HackHackGui(Minecraft minecraft) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        super.drawScreen(mouseX, mouseY, partialTicks);
         this.fontRenderer).drawStringWithShadow("HackHack", 2.0F, 2.0F, 3166352);
