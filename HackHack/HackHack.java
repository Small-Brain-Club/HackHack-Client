package me.vp.HackHack;

import me.vp.HackHack.command.*;
...
import me.vp.HackHack.utils.FileMang;
...
public class HackHack
{
    ...
    public void fuckcuck(Text event)
    {
        ...
        {
            if (!(mc.currentScreen instanceof HackHackGui))
            {
                Iterator textIter = HackHackGui.textWins.iterator();
