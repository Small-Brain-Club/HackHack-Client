...
public class BedAura extends Module
{
    ...
    public BedAura()
    {
        super("BedAura", 0, Category.COMBAT, "Ez", settings);
    }
    ...
    public float calculateDamage(double posX, double posY, double posZ, Entity entity)
    {
        ...
        double blockDensity = entity.world.getBlockDensity(vec3d, entity.getBoundingBox());
    ...
    public float getBlastReduction(EntityLivingBase entity, float damage, Explosion explosion)
    {
        if (entity instanceof EntityPlayer)
        {
            ...
            damage = CombatRules.getDamageAfterAbsorb(damage, (float) ep.getTotalArmorValue(), (float) ep.getAttribute(SharedMonsterAttributes.ARMOR_TOUGHNESS).getAttributeValue());
        ...
        {
            damage = CombatRules.getDamageAfterAbsorb(damage, (float) entity.getTotalArmorValue(), (float) entity.getAttribute(SharedMonsterAttributes.ARMOR_TOUGHNESS).getAttributeValue());
            return damage;
        }
    }
